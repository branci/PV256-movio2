...
import cz.muni.fi.pv256.movio2.uco_422678.Constants;
import cz.muni.fi.pv256.movio2.uco_422678.Movie;
import cz.muni.fi.pv256.movio2.uco_422678.MovieAPI;
import cz.muni.fi.pv256.movio2.uco_422678.MovieDTO;
import cz.muni.fi.pv256.movio2.R;
import cz.muni.fi.pv256.movio2.uco_422678.MovieDBHelper;
import cz.muni.fi.pv256.movio2.uco_422678.MovieManager;
import cz.muni.fi.pv256.movio2.uco_422678.MovieManagerImpl;
import static cz.muni.fi.pv256.movio2.uco_422678.DownloadService.CHANNEL;
...
public class UpdaterSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int SYNC_INTERVAL = 60 * 60 * 24; // a day
    ...
    public void onPerformSync(Account account, Bundle extras, String authority, ContentProviderClient provider, SyncResult syncResult) {
        try {
            ...
            MovieManager movieManager = new MovieManagerImpl(database);

            List<Movie> savedMovies = movieManager.getSavedMovies();
            for (int i = 0; i < savedMovies.size(); i++) {
                ...
                Movie updatedMovie = dtoToMovie(requestMovie);
    ...
    private boolean compareMovies(Movie oldMovie, Movie newMovie){
        if (oldMovie.getBackdrop().compareTo(newMovie.getBackdrop()) !=0 ||
                ...
                Math.abs(oldMovie.getPopularity() - newMovie.getPopularity()) > 0.00001 ||
